...
\begin{table}[]
\centering
\label{serijske_meritve}
\begin{tabular}{|lllll}
\cline{1-3}
\multicolumn{1}{|l|}{Velikost jate} & \multicolumn{1}{l|}{Serijski algoritem {[}FPS{]}} & \multicolumn{1}{l|}{Serijski algoritem z mrežo{[}FPS{]}} &  &  \\ \cline{1-3}
...
900                                 & 84.070                                            & 441.535                                                  &  & 
\end{tabular}
\caption{Meritve serijskega algoritma}
\end{table}
