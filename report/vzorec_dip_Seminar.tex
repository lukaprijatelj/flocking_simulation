...
Iz psevdokode \ref{serial_pseudo_code} se prav tako vidi, da v pomnilniku hranimo le dve tabeli ptic, ki jih vsako iteracijo zamenjamo. Prostorska zahtevnost algorima % Todo
\begin{algorithm}
